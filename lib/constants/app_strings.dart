class AppStrings {
  ...
  static const String snackBarCompleteGoal = 'Do you want to complete this project?';
  static const String snackBarUndoGoal = 'Do you want to undo this project?';
  ...
  //habits
  static const String habitHintText = 'Task title';
  static const String habitLabelText = 'Task Title';
  static const String habitDialogText = 'Goal time for this task';
  //goal - tasks
  static const String goalAppBarTitle = 'Create your projects';
  static const String task = 'Tasks';
  static const String quickTag = 'Quick tag';
  static const String goalHintText = 'Project name';
  ...
  static const List<String> quickTagsTitles = [
    'Project management app', 'Travel App', 'Finance tracker app', 'Chat app', 'E- commerce app', 'Voice assistant app', 'Gaming app', 'Fitness app', 'Social media app', 'Weather app', 'Calender app',
     'News app', 'Grocery Shop app', 'Learning management system', 'Blood bank app',
  ];
